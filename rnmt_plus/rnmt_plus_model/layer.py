...
from rnmt_plus_model.relational_rnn import RelationalRNN
...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, d_embed, d_hidden):
        ...
        self.encoder_gru = RelationalRNN(d_embed, d_hidden, batch_first=True, bidirectional=True)
...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, d_embed, d_hidden):
        ...
        self.decoder_gru = RelationalRNN(d_embed, d_hidden, batch_first=True)
